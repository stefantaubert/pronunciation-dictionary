...
from pronunciation_dictionary.pronunciation_selection import get_pronunciation_with_highest_weight
...
def test_component():
  ...
  result = get_pronunciation_with_highest_weight(pronunciations)
  assert result == ("b", "f")


def test_two_different_returns_greater():
  pronunciations = OrderedDict()
...
def test_empty_raise_error():
  ...
  with pytest.raises(ValueError) as error:
    get_pronunciation_with_highest_weight(pronunciations)
